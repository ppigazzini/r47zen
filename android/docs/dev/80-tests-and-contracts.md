...
| view-based keypad haptic gating and dispatch | `HapticFeedbackController.kt`, `ReplicaKeypadLayout.kt`, `MainActivity.kt` | `HapticFeedbackControllerTest.kt` | `cd android && ./gradlew :app:testDebugUnitTest --tests io.github.ppigazzini.r47zen.HapticFeedbackControllerTest` |
...
- `HapticFeedbackControllerTest.kt`: locks the `haptic_enabled` gate and the
