...
| settings dark theme and dialog surfaces | `AndroidManifest.xml`, `android/app/src/main/res/values/themes.xml`, `SettingsActivity.kt` | `SettingsActivityThemeTest.kt` | `cd android && ./gradlew :app:testDebugUnitTest --tests io.github.ppigazzini.r47.SettingsActivityThemeTest` |
