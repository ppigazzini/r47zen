...
JNIEXPORT jboolean JNICALL
Java_com_example_r47_ProgramLoadTestBridge_seedLargeFactorsInputNative(
    JNIEnv *env, jobject thiz) {
  (void)env;
  (void)thiz;
  if (!ram) {
...
JNIEXPORT jboolean JNICALL
Java_com_example_r47_ProgramLoadTestBridge_seedSpiralkInputNative(
    JNIEnv *env, jobject thiz) {
  (void)env;
  (void)thiz;
  if (!ram) {
...
JNIEXPORT void JNICALL
Java_com_example_r47_ProgramLoadTestBridge_sendSimFunctionNative(
...
JNIEXPORT void JNICALL
Java_com_example_r47_ProgramLoadTestBridge_sendSimKeyNative(
...
JNIEXPORT jboolean JNICALL
Java_com_example_r47_ProgramLoadTestBridge_beginSimFunctionNative(
    JNIEnv *env, jobject thiz, jint funcId) {
  (void)env;
  (void)thiz;
...
JNIEXPORT void JNICALL
Java_com_example_r47_ProgramLoadTestBridge_setNextLoadProgramFdNative(
...
JNIEXPORT void JNICALL
Java_com_example_r47_ProgramLoadTestBridge_clearLoadProgramFdOverrideNative(
    JNIEnv *env, jobject thiz) {
  (void)env;
  (void)thiz;
...
JNIEXPORT jboolean JNICALL
Java_com_example_r47_ProgramLoadTestBridge_isSimFunctionRunningNative(
    JNIEnv *env, jobject thiz) {
  (void)env;
  (void)thiz;
...
Java_com_example_r47_ProgramLoadTestBridge_snapshotStateNative(
    JNIEnv *env, jobject thiz) {
  (void)thiz;
...
Java_com_example_r47_ProgramLoadTestBridge_getXRegisterTypeNative(
    JNIEnv *env, jobject thiz) {
  (void)env;
  (void)thiz;
...
Java_com_example_r47_ProgramLoadTestBridge_getXRegisterStringNative(
    JNIEnv *env, jobject thiz) {
  (void)thiz;
